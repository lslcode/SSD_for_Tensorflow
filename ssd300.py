...
class SSD300:
    ...
    def generate_graph(self):
        ...
        # vvg16卷积层 1
        self.conv_1_1 = self.convolution(self.input, [3, 3,  3, 64], self.conv_strides_1,'conv_1_1')
        self.conv_1_2 = self.convolution(self.conv_1_1, [3, 3, 64, 64], self.conv_strides_1,'conv_1_2')
        ...
        # vvg16卷积层 2
        self.conv_2_1 = self.convolution(self.conv_1_2, [3, 3,  64, 128], self.conv_strides_1,'conv_2_1')
        self.conv_2_2 = self.convolution(self.conv_2_1, [3, 3, 128, 128], self.conv_strides_1,'conv_2_2')
        ...
        # vvg16卷积层 3
        self.conv_3_1 = self.convolution(self.conv_2_2, [3, 3, 128, 256], self.conv_strides_1,'conv_3_1')
        self.conv_3_2 = self.convolution(self.conv_3_1, [3, 3, 256, 256], self.conv_strides_1,'conv_3_2')
        ...
        # vvg16卷积层 4
        self.conv_4_1 = self.convolution(self.conv_3_2, [3, 3, 256, 512], self.conv_strides_1,'conv_4_1')
        self.conv_4_2 = self.convolution(self.conv_4_1, [3, 3, 512, 512], self.conv_strides_1,'conv_4_2')
        ...
        # vvg16卷积层 5
        self.conv_5_1 = self.convolution(self.conv_4_2, [3, 3, 512, 512], self.conv_strides_1,'conv_5_1')
        self.conv_5_2 = self.convolution(self.conv_5_1, [3, 3, 512, 512], self.conv_strides_1,'conv_5_2')
        ...
        self.conv_8_2 = self.convolution(self.conv_8_1, [3, 3,  256, 512], self.conv_strides_2,'conv_8_2')
        print('##   conv_8_2 shape: ' + str(self.conv_8_2.get_shape().as_list()))
        # ssd卷积层 9   
        self.conv_9_1 = self.convolution(self.conv_8_2, [1, 1, 512, 128], self.conv_strides_1,'conv_9_1')
        self.conv_9_2 = self.convolution(self.conv_9_1, [3, 3, 128, 256], self.conv_strides_2,'conv_9_2')
        print('##   conv_9_2 shape: ' + str(self.conv_9_2.get_shape().as_list()))
        # ssd卷积层 10    
        self.conv_10_1 = self.convolution(self.conv_9_2, [1, 1, 256, 128], self.conv_strides_1,'conv_10_1')
        self.conv_10_2 = self.convolution(self.conv_10_1, [3, 3, 128, 256], self.conv_strides_2,'conv_10_2')
        print('##   conv_10_2 shape: ' + str(self.conv_10_2.get_shape().as_list()))
        # ssd卷积层 11
        self.conv_11 = tf.nn.max_pool(self.conv_10_2, self.pool_size, self.pool_strides, "VALID")
        print('##   conv_11 shape: ' + str(self.conv_11.get_shape().as_list()))

        # 第 1 层 特征层，来源于conv_4_2  
        self.features_1 = self.convolution(self.conv_4_2, [3, 3, 512, self.default_box_size[0] * (self.classes_size + 4)], self.conv_strides_1,'features_1')
        print('##   features_1 shape: ' + str(self.features_1.get_shape().as_list()))
        # 第 2 层 特征层，来源于conv_7_1
        self.features_2 = self.convolution(self.conv_7_1, [3, 3, 1024, self.default_box_size[1] * (self.classes_size + 4)], self.conv_strides_1,'features_2')
        print('##   features_2 shape: ' + str(self.features_2.get_shape().as_list()))
        # 第 3 层 特征层，来源于conv_8_2
        self.features_3 = self.convolution(self.conv_8_2, [3, 3, 512,  self.default_box_size[2] * (self.classes_size + 4)], self.conv_strides_1,'features_3')
        print('##   features_3 shape: ' + str(self.features_3.get_shape().as_list()))
        # 第 4 层 特征层，来源于conv_9_2
        self.features_4 = self.convolution(self.conv_9_2, [3, 3, 256,  self.default_box_size[3] * (self.classes_size + 4)], self.conv_strides_1,'features_4')
        print('##   features_4 shape: ' + str(self.features_4.get_shape().as_list()))
        # 第 5 层 特征层，来源于conv_10_2
        self.features_5 = self.convolution(self.conv_10_2, [3, 3, 256,  self.default_box_size[4] * (self.classes_size + 4)], self.conv_strides_1,'features_5')
        print('##   features_5 shape: ' + str(self.features_5.get_shape().as_list()))
        # 第 6 层 特征层，来源于conv_11
        self.features_6 = self.convolution(self.conv_11, [1, 1, 256,  self.default_box_size[5] * (self.classes_size + 4)], self.conv_strides_1,'features_6')
    ...
    # jaccard算法
    # 计算IOU，rect1、rect2格式为[top_x,top_y,width,height]           
